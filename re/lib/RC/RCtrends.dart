...
class RCtrends extends StatefulWidget {
  @override
  _RCtrendsState createState() => _RCtrendsState();
}
class _RCtrendsState extends State<RCtrends> {
  List<String> _tags = [];
  ...
  Future<List<dynamic>> fetchSearchResults(String keyword) async {
    ...
    final url = 'https://serpapi.com/search.json?q=$keyword Hiring HR Candidates Choose&api_key=$apiKey';
